...
const slides = [
  {label: 'Relaxed', contentTitle: 'Find Your Outfits', contentDesc: 'Confused about your outfit? Don\'t worry! Find the best outfit here.', color: '#BFEAF5'},
  {label: 'Playful', contentTitle: 'Hear it First, Wear it First', contentDesc: 'Hating the clothes in your wardrobe? Explore hundreds of outfit ideas.', color: '#BEECC4'},
  {label: 'Excentric', contentTitle: 'Your Style, Your Way', contentDesc: 'Create your individual & unique style and look amazing everyday.', color: '#FFE4D9'},
  {label: 'Funky', contentTitle: 'Look Good, Feel Good', contentDesc: 'Discover the latest trends in fashion and explore your personality.', color: '#FFDDDD'},
];
      ...
      <Animated.View style={[styles.slider, {backgroundColor}]}>
        ...
        >
          {slides.map(({label}, index) => (
            <Slide key={`slide-item-${label}-${index}`} {...{label, right: index % 2}} />
          ))}
        </Animated.ScrollView>
      </Animated.View>
